...
namespace CompareCrsdAndVets.Common
{
    internal static class Message
    {
        ...
        internal const string Error_NoSuchFileDetail = "{0}の{1}フォルダ内に{1}ファイルが存在しません";
        internal const string Error_EmptyData = "{0}が空のため、処理対象外とします";
        internal const string Error_ReadFile = "{0}ファイルの読み込みに失敗しました";
        internal const string Error_ReadFileDetail = "{0}の{1}ファイルの読み込みに失敗しました";
        ...
        internal const string Error_NoEndEvent = "開始イベントに紐付く終了イベントがありません";
    }
}
